...
const BattleCard = ({
  ...
  return (
    <Link
      href={`/arena/${arena.id}`}
      className="group block min-w-0 border border-white/10 bg-white/[0.035] p-3 transition hover:-translate-y-0.5 hover:border-cyan-300/60"
    >
      ...
      <h3 className="mt-3 line-clamp-2 min-h-12 break-keep text-lg font-black leading-snug text-white group-hover:text-cyan-100">
        {arena.title}
      </h3>
      ...
      <div className="mt-4 bg-cyan-300 px-4 py-3 text-center text-sm font-black text-black transition group-hover:bg-cyan-200">
        {cta}
      </div>
    </Link>
  );
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-3 py-4 sm:px-6 sm:py-5 lg:px-8">
        ...
        <section className="border-b border-white/10 py-4 sm:py-5">
          <Link
            ...
            className="group relative block overflow-hidden border border-rose-300/50 bg-white/[0.035] p-4 text-left shadow-2xl shadow-rose-950/25 transition hover:border-rose-200 sm:p-5"
          >
